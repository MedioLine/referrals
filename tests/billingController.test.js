...
var index_1 = require("../src/index"); // Assuming this is where the Express app is initialized
describe('Billing Controller', function () {
    it('should create an invoice', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    it('should process a payment', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.default)
